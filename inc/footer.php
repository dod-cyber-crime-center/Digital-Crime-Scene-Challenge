 ...
 * File:        inc/footer.php
 * Version:     1.0
 * Description: Standard viewport footer for mobile web application
 ...
 */
?><!-- CLOSED IN FOOTER --><!-- CLOSED IN FOOTER!!! --><!-- CLOSED IN FOOTER!!! -->
  </div>
  <div id="footer" data-role="footer" data-theme="a" class="sidePadded">
  	<footer>
