[DC3](http://dc3.mil) Digital Crime Scene Challenge
===================================================
...
*Department of Defense Cyber Crime Center ([DC3](http://www.dc3.mil))*
...
---------------------------------------
XAMPP from [ApacheFriends.org](http://www.apachefriends.org/en/xampp.html)
- Apache 2.x
- PHP 5.3 or above
- MySQL 5.1 or above
- phpMyAdmin
...
> - Date Format 1.2.3 by [Scott Trenda](scott.trenda.net) and Kris Kowal (MIT License)
...
> - jQuery UI 1.8.13 by [AUTHORS.txt](http://jqueryui.com/about/) (GPL v2 or MIT Licenses)
> - jQuery Mobile v1.0b3 by the jQuery Project (GPL v2 or MIT Licenses)
> - jQuery UI Widget by [AUTHORS.txt](http://jqueryui.com/about/) (GPL v2 or MIT Licenses)
